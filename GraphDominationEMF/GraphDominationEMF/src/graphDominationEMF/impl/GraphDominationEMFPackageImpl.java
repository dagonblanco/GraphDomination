 ...
 * @generated
 */
public class GraphDominationEMFPackageImpl extends EPackageImpl implements GraphDominationEMFPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see graphDominationEMF.GraphDominationEMFPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private GraphDominationEMFPackageImpl() {
		super(eNS_URI, GraphDominationEMFFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link GraphDominationEMFPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static GraphDominationEMFPackage init() {
		if (isInited) return (GraphDominationEMFPackage)EPackage.Registry.INSTANCE.getEPackage(GraphDominationEMFPackage.eNS_URI);

		// Obtain or create and register package
		GraphDominationEMFPackageImpl theGraphDominationEMFPackage = (GraphDominationEMFPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof GraphDominationEMFPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new GraphDominationEMFPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theGraphDominationEMFPackage.createPackageContents();

		// Initialize created meta-data
		theGraphDominationEMFPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theGraphDominationEMFPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(GraphDominationEMFPackage.eNS_URI, theGraphDominationEMFPackage);
		return theGraphDominationEMFPackage;
	}
	 ...
	 * @generated
	 */
	public GraphDominationEMFFactory getGraphDominationEMFFactory() {
		return (GraphDominationEMFFactory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getGraph_Name(), ecorePackage.getEString(), "name", "", 0, 1, Graph.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getGraph_Id(), ecorePackage.getELong(), "id", null, 0, 1, Graph.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEOperation(getNode__GetAdjacentNodes(), null, "getAdjacentNodes", 0, 1, IS_UNIQUE, IS_ORDERED);
