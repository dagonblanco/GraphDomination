...
//		layout.addNewWizardShortcut("org.eclipse.ui.wizards.new.file");//$NON-NLS-1$
		...
		layout.addNewWizardShortcut("graphdomgraphics.ui.CreateSampleProjectWizard");//$NON-NLS-1$
		layout.addNewWizardShortcut("graphdomgraphics.ui.CreateDiagramWizard");//$NON-NLS-1$
