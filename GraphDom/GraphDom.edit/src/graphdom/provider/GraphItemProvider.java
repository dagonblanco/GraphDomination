...
/**
 * This is the item provider adapter for a {@link graphdom.Graph} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GraphItemProvider 
	...
	/**
	 * This adds a property descriptor for the Graph Name feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addGraphNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Graph_graphName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Graph_graphName_feature", "_UI_Graph_type"),
				 GraphdomPackage.Literals.GRAPH__GRAPH_NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Graph)object).getGraphName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GraphdomPackage.Literals.GRAPH__NODES,
				 GraphdomFactory.eINSTANCE.createNode()));

		newChildDescriptors.add
			(createChildParameter
				(GraphdomPackage.Literals.GRAPH__EDGES,
				 GraphdomFactory.eINSTANCE.createEdge()));
	}
