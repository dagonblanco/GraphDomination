 ...
 * @generated
 */
public class GraphdomPackageImpl extends EPackageImpl implements GraphdomPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see graphdom.GraphdomPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private GraphdomPackageImpl() {
		super(eNS_URI, GraphdomFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link GraphdomPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static GraphdomPackage init() {
		if (isInited) return (GraphdomPackage)EPackage.Registry.INSTANCE.getEPackage(GraphdomPackage.eNS_URI);

		// Obtain or create and register package
		GraphdomPackageImpl theGraphdomPackage = (GraphdomPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof GraphdomPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new GraphdomPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theGraphdomPackage.createPackageContents();

		// Initialize created meta-data
		theGraphdomPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theGraphdomPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(GraphdomPackage.eNS_URI, theGraphdomPackage);
		return theGraphdomPackage;
	}
	 ...
	 */
	@Override
	public EOperation getGraph__IsTotallyDominated() {
	 ...
	 */
	@Override
	public EOperation getGraph__IsIndependentlyDominated() {
